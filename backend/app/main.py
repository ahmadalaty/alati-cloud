...
REFUND_POLICY_HTML = _legal_page_html("Refund Policy", f"""
  ...
  <h2>4. Refunds</h2>
  <p>If you're not satisfied, you may request a full refund within 14 days of a Premium charge, provided you have used fewer than 10 scans during the billing period being refunded. Contact us at the email below to request one. Refund requests outside this window, or above the usage threshold, are considered on a case-by-case basis. Refunds are limited to one per customer, and may be refused where there is evidence of abuse. Approved refunds are processed back to your original payment method via Paddle.</p>
